import 'package:fooder/widgets/clip_shadow.dart';
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Column(
                        ...
                        children: [
                          menu
                              ? Image.asset(Helper.getAssetName('more_filled.png', 'virtual'))
                              : Image.asset(Helper.getAssetName('more.png', 'virtual')),
                          menu
                    ...
                    GestureDetector(
                      ...
                      child: Column(
                        ...
                        children: [
                          offer
                              ? Image.asset(Helper.getAssetName('bag_filled.png', 'virtual'))
                              : Image.asset(Helper.getAssetName('bag.png', 'virtual')),
                          offer
                    ...
                    GestureDetector(
                      ...
                      child: Column(
                        ...
                        children: [
                          profile
                              ? Image.asset(Helper.getAssetName('user_filled.png', 'virtual'))
                    ...
                    GestureDetector(
                      ...
                      child: Column(
                        ...
                        children: [
                          more
                              ? Image.asset(Helper.getAssetName('menu_filled.png', 'virtual'))
                              : Image.asset(Helper.getAssetName('menu.png', 'virtual')),
                          more
                              ? const Text('More', style: TextStyle(color: AppColor.orange))
                              : const Text('More'),
                        ],
                      ),
                    ),
...
class CustomNavBarClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.quadraticBezierTo(size.width * 0.375, 0, size.width * 0.375, size.height * 0.1);
    path.cubicTo(
      size.width * 0.4,
      size.height * 0.9,
      size.width * 0.6,
